...
class ContactType extends Type{
    public function __construct(){
        ...
        $query = 'select id,icon, description from contacttypes where id=? '; //query
   ...
   public static function getAll(){
    ...
    $query = 'select id,icon, description from contacttypes ';
    ...
    while ($command->fetch()){ //fetch es ir y traer
       //populate list
       array_push($list, new ContactType($id,$icon, $descripcion));
    }
